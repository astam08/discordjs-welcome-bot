...
let font = await jimp.loadFont(jimp.FONT_SANS_32_BLACK) //We declare a 32px font
  ...
  welcome.print(font64, 265, 55, `Selamat Datang  ${member.user.username}`) //We print the new user's name with the 64px font
  welcome.print(bfont64, 265, 125, `Di ${member.guild.name}`)
  welcome.print(font64, 265, 195, `Kamu Member ke  ${member.guild.memberCount} Semoga betah `)
